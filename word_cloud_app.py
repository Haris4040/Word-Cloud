...
if uploaded_file:
    ...
    st.sidebar.markdown("---")
    st.sidebar.subheader("Join me on Upwork for more projects!")
    # add a youtube video
    st.sidebar.video("https://www.upwork.com/freelancers/muhammadh1599")
    st.sidebar.markdown("---")
    # add author name and info
    st.sidebar.markdown("Created by: [Data Scientist Muhammad Haris](https://www.linkedin.com/in/muhammad-haris-b1bb9122b/)")
    st.sidebar.markdown("Contact: [Email](mailto:muhammad.haris4040@gmail.com)")
